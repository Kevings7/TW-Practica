<?php $__env->startSection('title', 'Mis incidencias'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row row-cols-1 g-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                ...
                                <p class="card-text">
                                    <strong>Descripción:</strong> <?php echo e($incidencia->descripcion); ?>
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <p>Todavía no has reportado ninguna incidencia.</p>
        <?php endif; ?>
    </div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\aitor\OneDrive\Escritorio\IU-Ayuntamiento-Laravel\IU-Ayuntamiento-Laravel\resources\views/incidencias/mine.blade.php ENDPATH**/ ?>